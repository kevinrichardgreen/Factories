...
public:
  ...
  static std::unique_ptr<Interface> Create(std::string name, ConstructorArgs... args);
...
template <class Interface, class... ConstructorArgs>
std::unique_ptr<Interface> Factory<Interface,ConstructorArgs...>::Create(std::string name, ConstructorArgs... args)
{
  ...
  return std::unique_ptr<Interface>(instance);
}
